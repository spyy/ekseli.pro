      ...
      <div className="modal-dialog">
          ...
          <div className="modal-body">
            <div className="form-floating my-3">
                <input type="email" className="form-control" placeholder="Syötekentän nimi" value={ name } onChange={event => setName(event.target.value)} />
                <label>Nimi</label>
            </div>
            <div className="form-floating my-3">
                <select className="form-select" value={ type } onChange={event => setType(event.target.value)} disabled>
                    <option>Ominaisuus kehitteillä</option>
                </select>
                <label>Syötekentän tyyppi</label>
            </div>
            <div className="form-floating my-3">
                <select className="form-select" value={ inputmode } onChange={event => setInputmode(event.target.value)}>
            ...
            <div className="form-floating my-3">
                <select className="form-select" value={ required } onChange={event => setRequired(event.target.value)} disabled>
                    <option>Ominaisuus kehitteillä</option>
                </select>
                <label>Pakollinen</label>
            </div>
            <div className="form-floating my-3">
                <select className="form-select" value={ disabled } onChange={event => setDisabled(event.target.value)} disabled>
                    <option>Ominaisuus kehitteillä</option>
                </select>
                <label>Käytössä</label>
            </div>
            <div className="form-floating my-3">
                <select className="form-select" value={ readonly } onChange={event => setReadonly(event.target.value)} disabled>
                    <option>Ominaisuus kehitteillä</option>
                </select>
